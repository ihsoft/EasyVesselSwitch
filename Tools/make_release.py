...
PACKAGE_TITLE = 'Easy Vessel Switch'
...
SRC_COMPILED_BINARY = '/Source/bin/Release/EasyVesselSwitch.dll'
...
DEST_RELEASE_NAME_FMT = 'EasyVesselSwitch_v%d.%d.%d'
# A file name format for releases with build field other than zero.
DEST_RELEASE_NAME_WITH_BUILD_FMT = 'EasyVesselSwitch_v%d.%d.%d_build%d'
# The name of the destintation binary.
DEST_VERSIONED_BINARY = '/EasyVesselSwitch.dll'


# Sources to be updated post release (see UpdateVersionInSources).
# All paths must be full.
SRC_REPOSITORY_VERSION_FILE = SRC + '/EasyVesselSwitch.version'
...
DEST_PLUGIN_VERSION_COPY = (
    ...
    + '/GameData/EasyVesselSwitch/Plugins/EasyVesselSwitch.version')
...
STRUCTURE = collections.OrderedDict({
  ...
  '/GameData/EasyVesselSwitch/Plugins/PluginData' : [
    '/PluginData/*',
  ]
})
